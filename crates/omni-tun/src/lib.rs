...
impl WgMode {
    ...
    /// compatibility with relay fallback. Kernel mode requires transparent relay
    /// support which adds complexity. Userspace (BoringTun) works reliably across
    /// all platforms with standard relay encapsulation.
