...
"%SCRIPT_DIR%\i386\tapinstall" install "%SCRIPT_DIR%\i386\OemVista.inf" %DEVICE_HWID%
if %errorlevel% neq 0 (
...
netsh interface ip set dnsservers %DEVICE_NAME% static address=10.0.0.1
if %errorlevel% neq 0 (
